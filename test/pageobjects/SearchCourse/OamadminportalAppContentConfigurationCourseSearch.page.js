...
class OamadminportalAppContentConfigurationCourseSearchPage extends Page {
  ...
  get nolabel_div () { return $('FORM.form-horizontal > DIV:nth-of-type(3)') } 
  get search_app_message () { return $('BUTTON:nth-of-type(1) > APP-MESSAGE') } 
  get tc8_p () { return $('APP-COURSE-SEARCH > #content-container > DIV.container-large > DIV:nth-of-type(2) > DIV:nth-of-type(2) > #courseSearchResultTable > DIV:nth-of-type(1) > #courseSearchResultTable-table > TBODY > TR > TD:nth-of-type(1) > P.form-control-plaintext') } 
