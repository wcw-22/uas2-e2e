...
class OamadminportalAppContentAdmissionAdmissionapplicationViewA33000576Page extends Page {
  get financialAid_app_message () { return $('APP-FINANCIAL-AID-VIEW > DIV.col-12.mt-3 > DIV.card > DIV:nth-of-type(1) > H6.mb-0.mt-1 > APP-MESSAGE') } 
  get nolabel_app_message () { return $('APP-FINANCIAL-AID-VIEW > DIV.col-12.mt-3 > DIV.card > DIV:nth-of-type(2) > DIV:nth-of-type(1) > DIV:nth-of-type(1) > APP-MESSAGE') } 
  get no_div () { return $('APP-FINANCIAL-AID-VIEW > DIV.col-12.mt-3 > DIV.card > DIV:nth-of-type(2) > DIV:nth-of-type(1) > DIV:nth-of-type(2)') } 
