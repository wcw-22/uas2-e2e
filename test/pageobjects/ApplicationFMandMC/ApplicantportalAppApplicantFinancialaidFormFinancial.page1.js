...
class ApplicantportalAppApplicantFinancialaidFormFinancialPage1 extends Page {
  ...
  get addFamilyMember_app_message () { return $('H4.modal-title.float-start > APP-MESSAGE') } 
  ...
  get yes_radioInput () { return $('#new_stayingWithApplicantFlagYes') } 
  get yes_radioInput () { return $('#new_stayingWithApplicantFlagYes') } 
  ...
  get yes_radioInput () { return $('#new__employedA1_ableToProvideSalarySlipFlagYes') } 
  get yes_radioInput () { return $('#new__employedA1_ableToProvideSalarySlipFlagYes') } 
  get addFamilyMember_app_message () { return $('DIV:nth-of-type(12) > DIV.col-12.text-end > BUTTON > APP-MESSAGE') } 
  ...
  get yes_radioInput () { return $('#medicalConditionYes') } 
  get yes_radioInput () { return $('#medicalConditionYes') } 
...
} // end of class ApplicantportalAppApplicantFinancialaidFormFinancialPage1
