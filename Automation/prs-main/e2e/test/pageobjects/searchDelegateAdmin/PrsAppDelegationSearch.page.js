...
class PrsAppDelegationSearchPage extends Page {
  ...
  get manageDelegateSearch_span () { return $('H2 > APP-MESSAGE > SPAN') } 
  get validation_error_div () { return $('DIV.alert.alert-danger') } 


  open() {
    return super.open('/prs/app/delegation/search') // update as needed
  }
} // end of class PrsAppDelegationSearchPage

module.exports = new PrsAppDelegationSearchPage();
